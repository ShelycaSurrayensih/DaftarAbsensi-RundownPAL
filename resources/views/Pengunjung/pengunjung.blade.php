            ...
            <div class="row justify-content-center h-100 align-items-center">
                <div class="col-md-5">
                    <div class="form-input-content text-center error-page">
                        <svg viewBox="0 0 24 24" width="100" height="100" stroke="currentColor" stroke-width="2"
                        ...
                        <p>Anda Sudah Melakukan Absensi</p>
                            ...
                            <a class="btn btn-primary" href="{{ route('suncar.pdf', $rundownDetail->idRundowns) }}">Download Susunan Acara</a>
                                   <!--**********************************
 Scripts
***********************************-->
                <!-- Required vendors -->
